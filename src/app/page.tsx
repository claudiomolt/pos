      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="pt-4 border-t border-zinc-800 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <a href="/pos" className="rounded-lg border border-zinc-700 bg-[#0f1729] px-3 py-2.5 text-sm text-center text-zinc-300 hover:border-[#f7931a] hover:text-[#f7931a] transition">
              ⚡ POS
            </a>
            ...
            <a href="/pos/test-order-123" className="rounded-lg border border-zinc-700 bg-[#0f1729] px-3 py-2.5 text-sm text-center text-zinc-300 hover:border-[#f7931a] hover:text-[#f7931a] transition">
              📄 Order
            </a>
          </div>
        </div>
